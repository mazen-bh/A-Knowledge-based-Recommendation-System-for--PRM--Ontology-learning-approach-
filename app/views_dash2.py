...
# We use cosine-similarity and torch.topk to find the highest 3 scores
    ...
    return render(request,'result2.html',{'concept_name':concept_name,'definition':definition,'sous_concept':sous_concept})
